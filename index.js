...
//       'Click sur une carte pour la retourner et trouve sa jumelle. Si tu trouves la paire, les cartes restent faces découvertes et tu peux continuer.';
...
//       'Change la difficulté si tu veux augmenter le nombre de paires. Ton score sera calculé selon le niveau de difficulté et ton temps de jeu.';
...
//       '- Site web créé le 29 septembre 2020';
//   } else {
...
//     document.querySelector('.span-5').innerHTML =
//       'Click on a card to flip it over and find its twin. If you find the pair, the cards remain face up and you can continue.';
//     document.querySelector('.span-6').innerHTML =
//       'If you make a mistake, the last 2 cards turned over become hidden again.';
//     document.querySelector('.span-7').innerHTML =
//       'Increase the difficulty if you want to add pairs of cards. Your score will be calculated according to the level of difficulty and the time taken.';
...
//     document.querySelector('.span-12').innerHTML =
//       '- Website created on September 29, 2020';
//   }
// }
